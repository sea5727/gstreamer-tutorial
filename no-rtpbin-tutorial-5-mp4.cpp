...
static int 
make_pipeline(char * name, const char *host, int port)
{
    ...
    g_object_set(newdata->file_src, "location", "/home/jdin/youtube_ZwTWatG3fL8_1080p_mhd.mp4", NULL);
...
int main(int argc, char *argv[])
{
    ...
    make_pipeline("first", "192.168.0.219", 5004);
